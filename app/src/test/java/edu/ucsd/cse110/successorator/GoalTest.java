...
public class GoalTest {
    private Goal goalOne = new Goal(0,"Thing1", 0, false,"one_time");
    private Goal goalTwo = new Goal(1,"Thing2", 1, false,"one_time");
    ...
    public void testEqualsSameValue() {
        Goal goalThree = new Goal(0,"Thing1", 0, false,"one_time");
        Goal goalFour = new Goal(1, "Thing1", 0, false,"one_time");
    ...
    public void testHash() {
        int hashGoalOne = Objects.hash(goalOne.id(), goalOne.mit(), goalOne.sortOrder(), goalOne.isCrossed(), goalOne.recurrence());
